<?php 
  ...
  try 
  {
     ...
     $query = "SELECT *
               ...
               WHERE com_cod_estado_proceso=est_id and com_cod_marca=mar_id AND com_cod_centro_costo=cen_id AND com_cod_estado_proceso=pro_id AND com_cod_prioridad=pri_id AND com_cod_tipo_equipo=tip_id AND com_activo_equipo like '$activo%'";
