    ...
    /**
        ...
        $mail->AddCC("dlizcano@uninorte.edu.co", "Danilo Lizcano Arregocés");
        ...
        $mail->Body =   'El día : ' . "$f_prestamo" . ' se realiza entrega de un equipo activo Nro : '. "$activo_equipo " . ' en calidad de soporte o contingencia.'. "\r\n" .
                                ...
                                'Nota importante:'. "\r\n" .
                                '* Se instala switch en calidad de préstamo o contingencia. En caso del que el switch dañado no tenga reparación,' . "\r\n" .
                                '  el soporte quedará de manera definitiva en el área y DTIC deberá solicitar un nuevo switch por compra, el cual ' . "\r\n".
                                '  quedará como soporte o contingencia en el área de mantenimiento. ' . "\r\n" . "\r\n" .
