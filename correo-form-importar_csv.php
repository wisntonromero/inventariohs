...
<!DOCTYPE html>
  	...
  	<body>
  		<div class="row">
	  		...
	  		<form action='correo-php-validar_csv.php' method='post' enctype="multipart/form-data">
	   			Seleccionar Archivo csv : <input type='file'  name='sel_file' size='20'>
	   			<input type='submit' name='submit' value='Validar archivo csv'>
	  		</form>

	  		<form action='correo-php-importar_csv.php' method='post' enctype="multipart/form-data">
