...
{      
	$.ajax({
		url: 'red-php_actualizar_punto_de_red_grilla.php',
		type: 'POST',
		dataType: "html",
	   		data: {
...
{ 
	this.editableGrid = new EditableGrid("puntos_de_red", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("red-php_cargar_datos_tabla_puntos_de_red_grilla.php?db_tablename=puntos_de_red");
};
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
  ...
  if ( confirm('Are you sur you want to delete the row id ' + id )  ) {
        ...
        $.ajax({
		url: 'red-php_borrar_punto_de_red_grilla.php',
		type: 'POST',
		dataType: "html",
		data: {
...
DatabaseGrid.prototype.addRow = function(id) 
{
  ...
  var self = this;
        ...
        $.ajax({
		url: 'red-php_ingresar_punto_de_red_grilla.php',
		type: 'POST',
		dataType: "html",
		data: {
			tablename : self.editableGrid.name,
		...
		{ 
			if (response == "ok" ) {
              ...
              alert("error registro no se adiciono");
		},
		error: function(XMLHttpRequest, textStatus, exception) { alert("Ajax failure\n" + errortext); },
		async: true
	});
