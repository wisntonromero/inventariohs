  ...
  include('config.php');
    ...
    while ($cc <= 100) {
        ...
        //echo $i;
            ...
            //$qry =mysql_query("SELECT dir_ip_sw, puerto_sw, vlan, punto_de_red, bloque, piso, cubiculo FROM bitacora_switches WHERE dir_ip_sw LIKE '172.18.$cc.$k' ORDER BY dir_ip_sw, puerto_sw ASC ");  
            $qry =mysql_query("SELECT switches.sw_id, switches.dir_ip_sw, bitacora_switches.puerto_sw, bitacora_switches.vlan, bitacora_switches.punto_de_red FROM switches JOIN bitacora_switches ON switches.sw_id = bitacora_switches.id_sw WHERE dir_ip_sw LIKE '172.18.$cc.$k' ORDER BY dir_ip_sw, puerto_sw ASC ");  
            ...
            header("Content-Disposition: attachment; filename=bitacora_por_switches.xls");  
