<?php
    ...
    /**
       ...
       // $mail->AddCC("weromero@uninorte.edu.co", "Winston Elias Romero Duarte");
        ...
        $mail->Subject = 'Entrada a bodega de un pc nuevo para soporte, activo:  ' . "$activo_equipo";
        //Read an HTML message body from an external file, convert referenced images to embedded,
        //convert HTML into a basic plain-text alternative body
        //$mail->msgHTML(file_get_contents('inicio.php'), dirname(__FILE__));
        //Replace the plain text body with one created manually
        $mail->Body =   'El día de hoy se realiza la entrada de un equipo nuevo a la bodega, con activo Nro : '. "$activo_equipo " . ' para soporte o préstamo.'. "\r\n" .
                                'Tenga en cuenta la siguientes información descrita abajo. '. "\r\n" . "\r\n" .
                                'Activo equipo que entra a bodega para soporte o préstamo            : ' ."$activo_equipo". "\r\n" .
